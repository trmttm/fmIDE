...
class ConfigurationTest(ConfigurationABC):
    ...
    def set_up(view: ViewABC, interactor: BoundaryInABC, presenters: PresentersABC, mouse: MouseControllerABC):
        ...
        w = vm.entry_text, vm.entry_x, vm.entry_y, vm.entry_width, vm.entry_height, vm.entry_sheet, vm.entry_shape_id, vm.cb_format, vm.cb_num_format, vm.check_btn, vm.entry_uom, vm.check_btn_breakdown_account
