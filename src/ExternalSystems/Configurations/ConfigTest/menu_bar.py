...
def create_menu_bar_model(interactor: BoundaryInABC, view: ViewABC, presenters: PresentersABC,
    ...
    menu_bar_model = {
        'File': {
            ...
            'Load Inputs from specified Input Setter.csv': lambda: interactor.load_inputs_from_specified_csv(
        ...
        'Canvas': {
            ...
            'Insert Macro': {
                ...
                'Add Sensitivity Target': lambda: interactor.add_command_add_sensitivity_target(),
                'Add Sensitivity Input': lambda: interactor.add_command_add_sensitivity_input(),
            },
        },
        'Analyze': {
            'Add Graph': {
